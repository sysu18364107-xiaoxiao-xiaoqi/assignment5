...
logger = Logger(logdir="./tensorboard_logs_googlenet_Adam", flush_secs=10)
...
model_path = '/home/yewei/assignment5exp/pretrained_models/googlenet-1378be20.pth'
model = googlenet.googlenet(pretrained_path=model_path,num_classes=46).to(device)
